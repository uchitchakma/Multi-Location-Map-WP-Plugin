...
/**
 * Register meta boxes for the 'location' post type.
 */
function mlm_register_location_meta_boxes() {
    add_meta_box(
        'location_details',
        'Location Details',
        'mlm_render_location_meta_box',
        'location',
        'normal',
        'default'
    );
 ...
 */
function mlm_render_location_meta_box($post) {
 ...
 */
function mlm_save_location_meta_boxes($post_id) {
